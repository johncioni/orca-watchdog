...
class OrcaWatchdog < Formula
  ...
  url "https://github.com/johncioni/orca-watchdog/releases/download/v1.2.2/orca-watchdog-1.2.2.tar.gz"
  sha256 "e5108112718a0bfd156e9b1453783934a8d053fd9a8780ea2572bc4f55c0d3a0"
  license "MIT"
