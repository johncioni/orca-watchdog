...
class OrcaWatchdog < Formula
  ...
  url "https://github.com/johncioni/orca-watchdog/releases/download/v1.2.1/orca-watchdog-1.2.1.tar.gz"
  sha256 "b3a8b19b40b16725721738d94e2c1f356205d30daf320f173c8f475959218d3f"
  license "MIT"
